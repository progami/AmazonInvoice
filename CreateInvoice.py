...
def create_invoice(Order_id, customer_info):
  ...
  # if excel file already exists, then return corresponding pdf
  if os.path.exists(xlsx_invoice_path):
    return xlsx_invoice_path.replace('.xlsx', '.pdf')
  # else generate a new excel file / pdf
  else:
